...
public class Spu {
    ...
    private Double spu_price; //腐品起价
    private String spu_title; //商品际题
    ...
    public Integer getSou_category_id() {
        return spu_category_id;
    }

    public void setSou_category_id(Integer spu_category_id) {
